...
export default async function BannerEmergencia() {
  ...
  return (
    <>
      <div className="bg-red-600 text-white py-2 px-4 fixed top-[45px] left-0 right-0 z-40 hover:bg-red-700 hover:text-white transition duration-300">
      ...
      {/* Espacio para evitar que el contenido quede detrás del banner y navbar */}
